    ...
    {block name='product_price_and_shipping'}
        {if $product.show_price}
            <div class="product-price-and-shipping">
                ...
                <p style="text-align: center;";><span>Continúa la Promo</span></p>
                <table width="auto" height="auto" style="width: auto; height: auto; margin-left: auto; margin-right: auto; float: center; font-size: 12px;">
                <tbody>
                <tr>
                <td><img src="https://cascoloco.com/iconos/Sistecredito2.png" width="30" height="30" /></td>
                <td>
                <p style="text-align: left;";><span>Sistecredito</span></p>
                </td>
                </tr>
                <tr>
                <td><img src="https://cascoloco.com/iconos/Esmio2.png" width="30" height="30" /></td>
                <td>
                <p style="text-align: left;";><span>Esmío</span></p>
                </td>
                </tr>
                <tr>
                <td><img src="https://cascoloco.com/iconos/Entrega.png" width="25" height="25" /></td>
                <td>
                <p style="text-align: left;";><span>Gratis a partir $200.000</span></p>
                </td>
                </tr>
                </tbody>
                </table>
